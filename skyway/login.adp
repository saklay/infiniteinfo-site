<HTML>
<HEAD>
	<TITLE>Infinite Information Incorporated | Skyway</TITLE>
...
<TR>
	<TD COLSPAN=6>
		...
		<TR>
			<TD ROWSPAN=2 VALIGN="TOP" ALIGN="CENTER" WIDTH=325>
			<FONT FACE="verdana, arial, helvetica" COLOR="#000000" SIZE=-1>

			<%
				if {![string match "" $rowSet]} {
					ns_adp_include valid.adp $username
					if {[set cart [CartUpdate]] != 0} {
						CartPrintContents $cart
    				}
				} else {
					ns_adp_include invalid.adp
				}
			%>
